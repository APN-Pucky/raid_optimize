...
impl Sim {
    pub fn new(
        args: Args, //allies: &'a Vec<&'a Hero>, enemies : &'a Vec<&'a Hero>,manual_ally:bool,manual_enemy: bool , iterations: u64
    ) -> Sim {
        ...
        vecit
            ...
            .map(|_i| {
                ...
                let mut wave = Wave::new(
                    ...
                    &mut players,
                    self.args.stats,
                    self.args.turn_limit,
                    self.args.turn_meter_threshold,
                );
                for x in 0..iter {
