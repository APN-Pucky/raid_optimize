...
impl<'a,const LEN:usize> Wave<'a,LEN> {
    pub fn execute_skill_hazier(&mut self,  skill : &Skill, actor :InstanceIndex, target :InstanceIndex, ) {
        ...
        match skill {
            ...
            Skill::EyeForAnEye {counterattack_turns: counter_attack_turns,damage_immunity_turns,control_immunity_turns,..} => {
            ...
            Skill::DarknightArbitrament {crit_rate_turns, crit_damage_turns , attack_damage_ratio,..} => {
