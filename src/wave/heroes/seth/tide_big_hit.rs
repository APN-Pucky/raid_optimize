...
impl TideBigHit {
    ...
    pub fn execute(&self, wave : &mut Wave,  skill : &Skill, attacker:InstanceIndex, defender:InstanceIndex, ) {
        ...
        wave.attack_single(attacker,defender, wave.get_max_health(attacker) * self.max_hp_damage_ratio, skill);
        ...
        wave.inflict_single(attacker,defender,Effect::Suffocated, chance,self.suffocated_turns);
    }
}
