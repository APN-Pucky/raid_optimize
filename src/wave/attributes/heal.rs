...
use crate::{debug, indent, data::{skill::{Skill, }, faction::Faction}, wave::heroes::maya::force_of_mercy::ForceOfMercy};
...
impl Wave<'_> {
    ...
    pub fn get_healing_effect(&self, actor: InstanceIndex) -> f32 {
        ...
        indent!({
            ...
            if let [ Skill::ForceOfMercy(ForceOfMercy { healing_effect, .. }) , ..] = self.heroes[actor].skills[..] {
