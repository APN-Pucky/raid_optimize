...
impl Wave<'_> {
    ...
    pub fn bond_hiddenwave(&self, ti : TeamIndex) -> f32 {
        ...
        debug!("team {} has {} HiddenWave allies -> dmg * {}", ti, self.count_faction(ti,Faction::HiddenWave), xfact);
        xfact
    }
    ...
    pub fn bond_swordharborguards(&self, ti : TeamIndex) -> f32 {
        ...
        debug!("team {} has {} SwordHarborGuards allies -> dmg * {}", ti, self.count_faction(ti,Faction::SwordHarborGuards), xfact);
        xfact
    }
    ...
    pub fn bond_theforgotten(&self, ti : TeamIndex) -> f32 {
        ...
        debug!("team {} has {} TheForgotten allies -> pierce * {}", ti, self.count_faction(ti,Faction::TheForgotten), xfact);
        xfact
    }
    ...
    pub fn bond_namelessbrotherhood(&self, ti : TeamIndex) -> f32 {
        ...
        debug!("team {} has {} NamelessBrotherhood allies -> pierce * {}", ti, self.count_faction(ti,Faction::NamelessBrotherhood), xfact);
        xfact
    }
    ...
    pub fn bond_holylightparliament(&self, ti :TeamIndex) -> f32 {
        ...
        debug!("team {} has {} HolyLightParliament allies -> heal * {}", ti, self.count_faction(ti,Faction::HolyLightParliament), xfact);
        xfact
    }
    ...
    pub fn bond_dragontribe(&self, ti: TeamIndex) -> f32 {
        ...
        debug!("team {} has {} DragonTribe allies -> critrate/mastery * {}", ti, self.count_faction(ti,Faction::DragonTribe), xfact);
        xfact
    }
    ...
    pub fn bond_eternalsect(&self, ti: TeamIndex) -> f32 {
        ...
        debug!("team {} has {} EternalSect allies -> dmg * {}", ti, self.count_faction(ti,Faction::EternalSect), xfact);
        xfact
    }
    ...
    pub fn bond_sunsetsages(&self, ti: TeamIndex) -> f32 {
        ...
        debug!("team {} has {} SunsetSages allies -> leech * {}", ti, self.count_faction(ti,Faction::SunsetSages), xfact);
        xfact
    }
